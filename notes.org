...
Unfortunately, this is only currently available on-campus
or using the URegina VPN.
...
**** TODO Check VPN/off-campus status

** Functions and Expressions
*** S-expressions
The syntax of Dr. Racket based around /S-Expressions/. Every S-Expression (or s-exp, pronounced "ess-exp") is either:
...
An /expression/ is a part of a program that produces a result: it either has a /value/, unless it raises an error or runs forever.
#+end_definition
